...
public class BuatAkta extends AppCompatActivity implements View.OnClickListener{
    Button btnPilih,btnPilih1,btnPilih2,btnPilih3,btnPilih4, btnUpload,btnUpload1,btnUpload2,btnUpload3,btnUpload4;
    TextView keteranganfile,keteranganfile1,keteranganfile2,keteranganfile3,keteranganfile4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_akta);
        ...
        btnPilih4 = findViewById(R.id.btnPilih4);
        ...
        keteranganfile4 = findViewById(R.id.keteranganfile4);

        btnPilih.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(BuatAkta.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)
                {
                    selectPdf();
                }
                else
                ActivityCompat.requestPermissions(BuatAkta.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        });
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btnUpload(pdfUri);
                    ...
                    Toast.makeText(BuatAkta.this, "Mohon Pilih File",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnPilih4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(BuatAkta.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)
                {
                        ...
                        reference.child(filename).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful())
                                    Toast.makeText(BuatAkta.this,"File Berhasil Di Upload",Toast.LENGTH_SHORT).show();
                                else
                                    Toast.makeText(BuatAkta.this,"File Gagal Di Upload",Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void btnPilih(Uri pdfUri) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode==9 && grantResults[0]==PackageManager.PERMISSION_GRANTED)
        {
            ...
            Toast.makeText(BuatAkta.this, "Tolong Izinkan Aplikasi",Toast.LENGTH_SHORT).show();
